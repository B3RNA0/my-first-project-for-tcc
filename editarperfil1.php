        ...
        function exibirImagem(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    document.getElementById("imagemAtual").src = e.target.result;
                };
            ...
            <form enctype="multipart/form-data" name="publitxt" method="POST" action="editarperfil2.php" id="form" onsubmit="return validarFormulario();">
                ...
                <?php
                    if (!empty($img)) {
                        ...
                        echo '<img src="'.$img.'" alt="Imagem Atual" width="100" id="imagemAtual">';
                    }
                ?>
                
                <label for="imagem" class="custom-file-upload">Selecione uma imagem</label>
                <input type="file" name="imagem" id="imagem" style="display:none;" onchange="exibirImagem(this);">
