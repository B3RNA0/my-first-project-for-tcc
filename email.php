...
function mandarEmail($nomeDestinatario,$To,$Subject,$Message) {
	...
	$mail->Username = 'FirstAid.Etec@gmail.com';         	// SMTP username
	$mail->Password = 'lwpdwahljnkzxosh';				// SMTP password
	$mail->From = 'FirstAid.Etec@gmail.com';
	$mail->FromName = utf8_decode('FIRST AID ETEC');
	if (gettype($To)=="array") {
