...
<div class="titulotexto">
    ...
    <img class="iconesite" src="iconesite.png" onclick="window.location.href='menu.php'">
        ...
        <div class="botaoheader">
            ...
            <button id="contact" class="contact" onclick="window.location.href='menu.php'"><i class="bi bi-box-arrow-left">
            <span>MENU</span></i></button>
    ...
    <div class="container" id="container">
        ...
        <form class="form-pergunta" enctype="multipart/form-data" name="publitxt" method="POST" action="publicar.php" id="form" onsubmit="return validarFormulario();">
