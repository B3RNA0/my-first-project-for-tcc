...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styleeditar2.css">
...
<div class="fotofundo">
    ...
    <div class="container">
    <span>EDITE SEU COMENTÁRIO</span>
        <form class="formulario-editar" enctype="multipart/form-data" name="publitxt" method="POST" action="editar2-2.php" id="form" onsubmit="return validarFormulario();">
            ...
            <input type="button" name="btn_cancela" value="CANCELAR" onclick="window.location.href='forum.php'">
        </form>
        </div>
    </div>
</body>
